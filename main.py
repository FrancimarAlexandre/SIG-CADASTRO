...
class App():
    ...
    def TelaInicial(self):
        ...
        self.EntryNome = ctk.CTkEntry(self.inicio_tab, font=("moderna", 20))
        ...
        self.EntryIdade = ctk.CTkEntry(self.inicio_tab, font=("moderna", 20))
        ...
        self.EntryGmail = ctk.CTkEntry(self.inicio_tab, font=("moderna", 20))
        ...
        self.EntryTelefone = ctk.CTkEntry(self.inicio_tab, font=("moderna", 20))
        ...
        self.EntryRua = ctk.CTkEntry(self.inicio_tab, font=("moderna", 20))
        ...
        self.EntryBairro = ctk.CTkEntry(self.inicio_tab, font=("moderna", 20))
        ...
        self.EntryCidade = ctk.CTkEntry(self.inicio_tab, font=("moderna", 20))
        ...
        self.EntryEstado = ctk.CTkEntry(self.inicio_tab, font=("moderna", 20))
        ...
        self.EntryNumero = ctk.CTkEntry(self.inicio_tab, font=("moderna", 20))
    ...
    def convert_dados(self):
        ...
        self.limpar_tela()
        db = DataBase()
        db.insert_dados(self.nome, self.email, self.idade, self.telefone, self.rua, self.bairro, self.cidade, self.estado, self.numero)
